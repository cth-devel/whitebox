      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12 lg:gap-16">
        <div className="flex-1">
          ...
          >
            ...
            <TextRoll className="text-[#f72a42] text-5xl sm:text-6xl lg:text-7xl xl:text-8xl">Saudi</TextRoll>
            <TextRoll className="text-[#f72a42] text-5xl sm:text-6xl lg:text-7xl xl:text-8xl">Arabia</TextRoll>
          ...
          <motion.p
            ...
            className="mt-6 text-lg sm:text-xl text-white/90 max-w-xl drop-shadow-sm"
          >
            Your Shipment, Our care
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
